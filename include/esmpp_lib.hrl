...
-define(SUBMIT_PAYLOAD(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS,
     DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, PayLen, Payload, PeTag, PeLen, PeVal,
     TempTag, TempLen, TempVal, TelMarTag, TelMarLen, TelMarVal, ValidityTs, VLen), <<
%% Mandatory parameters
Length:32/integer,               %% command_length
4:32/integer,                    %% command_id
0:32/integer,                    %% command_status NONE in native packet !!!!!
...
0:8/integer,                     %% priority_flag
0:8/integer,                     %% schedule_delivery_time NOW immediate_delivery TODO !!!
validity_period:VLen/integer,    %% validity_period NOW SMSC default              TODO !!!
1:8/integer,                     %% registered_delivery NOW delivery receipt requested TODO !!!
0:8/integer,                     %% replace_if_present_flag NOW default don't replace
DataCoding:8/integer,            %% data_coding
0:8/integer,                     %% sm_default_msg_id NOW unused
...
PeTag:16/integer,                  %% TLV for Entity ID
PeLen:16/integer,
PeVal:PeLen/binary,

TempTag:16/integer,                %% TLV for Template ID
TempLen:16/integer,
TempVal:TempLen/binary,

TelMarTag:16/integer,              %% TLV for Telemarketer ID
TelMarLen:16/integer,
TelMarVal:TelMarLen/binary
>>).

-define(SUBMIT_PAYLOAD_WITHOUT_TELEMARID(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS,DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, PayLen, Payload, PeTag, PeLen, PeVal,TempTag, TempLen, TempVal,ValidityTs, VLen), <<
...
0:8/integer,                     %% priority_flag
0:8/integer,                     %% schedule_delivery_time NOW immediate_delivery TODO !!!
ValidityTs:VLen/integer,         %% validity_period NOW SMSC default              TODO !!!
1:8/integer,                     %% registered_delivery NOW delivery receipt requested TODO !!!
0:8/integer,                     %% replace_if_present_flag NOW default don't replace
DataCoding:8/integer,            %% data_coding
0:8/integer,                     %% sm_default_msg_id NOW unused
...
-define(SUBMIT_SM2(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS,
     DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, LenSms, Text, PeTag, PeLen, PeVal,
     TempTag, TempLen, TempVal, TelMarTag, TelMarLen, TelMarVal, ValidityTs, VLen), <<
%% Mandatory parameters
Length:32/integer,               %% command_length
4:32/integer,                    %% command_id
...
0:8/integer,                     %% priority_flag
0:8/integer,                     %% schedule_delivery_time NOW immediate_delivery TODO !!!
ValidityTs:VLen/binary,           %% validity_period NOW SMSC default              TODO !!!
1:8/integer,                     %% registered_delivery NOW delivery receipt requested TODO !!!
0:8/integer,                     %% replace_if_present_flag NOW default don't replace
DataCoding:8/integer,            %% data_coding
0:8/integer,                     %% sm_default_msg_id NOW unused
...
-define(SUBMIT_WITHOUT_TELEMARID(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS,
     DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, LenSms, Text, PeTag, PeLen, PeVal,
     TempTag, TempLen, TempVal, ValidityTs, VLen), <<
%% Mandatory parameters
Length:32/integer,               %% command_length
4:32/integer,                    %% command_id
0:32/integer,                    %% command_status NONE in native packet !!!!!
...
-define(SUBMIT_SM_CUT(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS,
     ...
     SarSegNum, SarTotSeg, PeTag, PeLen, PeVal,TempTag, TempLen, TempVal, TelMarTag, TelMarLen, TelMarVal, ValidityTs, VLen), <<
...
-define(SUBMIT_SM_CUT_WITHOUT_TELEMARID(Length, SeqNum, ServType, LenT, SAddrTon, SAddrNpi, SAdress, LenS,
     DAddrTon, DAddrNpi, DAddr, LenD, DataCoding, LenMsg, Chunk, LenChunk, SarRefNum,
     SarSegNum, SarTotSeg, PeTag, PeLen, PeVal,TempTag, TempLen, TempVal, ValidityTs, VLen), <<
